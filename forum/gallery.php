...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Gallery | Help Forum</title>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <ul class="list-unstyled list-inline header-contact">
                            <li> <i class="fa fa-phone"></i> <a href="tel:"><a href="tel:">+8801816585922   </a>,<a href="tel:"> +447550741345 </a> </li>
                             <li> <i class="fa fa-envelope"></i> <a href="mailto:kanchanwelfaretrust001@gmail.com">form@gmail.com</a> </li>
                       </ul> <!-- /.header-contact  -->
	...
	<div class="page-heading text-center">
		...
		<div class="container zoomIn animated">
			...
			<p class="page-description">
				Few pictures of our target & activities.
			</p>
